          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
            {[
              ...
              <FadeIn key={prod.name} delay={staggerDelay(i)} direction="up">
                <div className="group flex flex-col h-full bg-[var(--color-brand-navy)] border border-[var(--color-brand-goldmuted)]/50 transition-all duration-300 hover:border-[var(--color-brand-gold)] hover:shadow-[0_0_0_1px_rgba(201,148,58,0.6),0_16px_40px_rgba(201,148,58,0.08)]">
